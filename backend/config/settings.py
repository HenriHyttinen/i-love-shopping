...
ADDRESS_VALIDATION_ENABLED = os.getenv("ADDRESS_VALIDATION_ENABLED", "0") == "1"
ADDRESS_VALIDATION_STRICT = os.getenv("ADDRESS_VALIDATION_STRICT", "0") == "1"
ADDRESS_VALIDATION_MIN_CONFIDENCE = float(os.getenv("ADDRESS_VALIDATION_MIN_CONFIDENCE", "0.75"))
